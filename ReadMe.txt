...
Aliases are created and modified by opening the script in a text editor
and moving to the bottom of the file. After editing the script, you will
need to Invoke the Run box and run the ‘Refresh’ aliases for new entries
to be recognised as aliases.
